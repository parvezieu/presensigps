...
class PresensiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $jam = date("H:i:s");
        //-6.362965419933092, 106.72890165963149
        $lok_kantor = DB::table('konfigurasi_lokasi')->where('id', 1)->first();
        ...
        if ($radius > $lok_kantor->radius) {
            echo "error|Maaf Anda Berada Diluar Radius Absensi, Jarak Anda Adalah " . $radius . " Meter Dari Kantor|";
        } else {
            if ($cek > 0) {
                $data_pulang = [
                    'jam_out' => $jam,
                ...
                if ($update) {
                    ...
                    echo "error|Maaf Absensi Harap Hubungi IT Support|out";
                }
            } else {
                $data = [
                    'nik' => $nik,
                ...
                if ($simpan) {
                    ...
                    echo "error|Maaf Absensi Gagal, Harap Hubungi IT Support|out";
                }
            }
        }
    }
    ...
    public function cetaklaporan(Request $request)
    {
        ...
        if (isset($_POST['exportword'])) {
            ...
            header("Content-Disposition: attachment; filename=Rekap Presensi PIM $time.docx");
        }
    ...
    public function cetakrekap(Request $request)
    {
        ...
        if (isset($_POST['exportexcel'])) {
            ...
            // Mendefinisikan nama file ekspor "hasil-export.xls"
            header("Content-Disposition: attachment; filename=Rekap Presensi PIM $time.xls");
        }
